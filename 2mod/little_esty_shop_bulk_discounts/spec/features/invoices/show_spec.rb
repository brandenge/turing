...
RSpec.describe 'invoices show' do
  ...
  it "shows the total revenue for this invoice" do
    ...
    expect(page).to have_content("Total Revenue: #{@invoice_1.merchant_total_revenue(@merchant1.id)}")
  end

  it "shows the total discounted revenue for this invoice" do
    visit merchant_invoice_path(@merchant1, @invoice_1)

    expect(page).to have_content("Total Discounted Revenue: #{@invoice_1.merchant_total_discounted_revenue(@merchant1.id)}")
  end
  ...
  context 'the invoice item is eligible for a discount' do
    it 'shows a link to the applicable bulk discount show page' do
      discount = create(:discount, merchant: @merchant1, percentage: 10, quantity: 10)
  ...
  context 'the invoice item is not eligible for a discount' do
    it 'does not show a link to a bulk discount show page' do
      discount = create(:discount, merchant: @merchant1, percentage: 10, quantity: 10)
