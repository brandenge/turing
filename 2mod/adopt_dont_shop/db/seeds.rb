...
pet_app_1 = PetApplication.create(application_id: app_2.id, pet_id: pet_1.id)
pet_app_2 = PetApplication.create(application_id: app_2.id, pet_id: pet_2.id)
pet_app_3 = PetApplication.create(application_id: app_2.id, pet_id: pet_3.id)
pet_app_4 = PetApplication.create(application_id: app_2.id, pet_id: pet_4.id)
pet_app_5 = PetApplication.create(application_id: app_3.id, pet_id: pet_1.id)
pet_app_6 = PetApplication.create(application_id: app_3.id, pet_id: pet_2.id)
pet_app_7 = PetApplication.create(application_id: app_3.id, pet_id: pet_3.id)
pet_app_8 = PetApplication.create(application_id: app_3.id, pet_id: pet_5.id)
pet_app_9 = PetApplication.create(application_id: app_4.id, pet_id: pet_7.id)
pet_app_10 = PetApplication.create(application_id: app_4.id, pet_id: pet_8.id)
pet_app_11 = PetApplication.create(application_id: app_4.id, pet_id: pet_9.id)
pet_app_12 = PetApplication.create(application_id: app_4.id, pet_id: pet_10.id)
