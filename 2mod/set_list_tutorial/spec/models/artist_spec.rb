...
RSpec.describe Artist do
  ...
  describe 'class methods' do
    ...
    describe '.with_a_million_play_count_song' do
      it 'returns all artists that have a song with over 1 million plays' do
        expect(Artist.with_a_million_play_count_song.sort).to eq([@rtj, @billie, @lcd].sort)
      end
    end
  end
end
