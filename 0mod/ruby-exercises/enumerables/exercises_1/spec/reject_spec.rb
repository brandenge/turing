RSpec.describe 'reject' do
  ...
  it 'remove words longer than 3 letters' do
  ...
  it 'remove numbers' do
    ...
    expect(remaining).to eq(["cat", "dog", "aimless"])
  end
